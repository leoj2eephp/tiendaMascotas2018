...
@NamedQueries({
    ...
    , @NamedQuery(name = "Usuario.loggear", query = "SELECT u FROM Usuario u WHERE u.rutUser = :rutUser AND u.clave = :claveUser")
...
public class Usuario implements Serializable {
    ...
    public String toString() {
        return "com.inacap.entities.Usuario[ rutUser=" + rutUser + " ]";
    }
